...
//}
    ...
    exports.defaults = function(value, defaultValue) {
        return (this.isEffective(value)) ? value : defaultValue;
    };

    exports.fetch = function(input) {
        input = input || {};
    ...
    exports.isEffective = function(input) {
        return (typeof(input) !== 'undefined' && input !== null);
    };

    exports.setDefaultValues = function(input) {
        input = input || {};
        // attributes
