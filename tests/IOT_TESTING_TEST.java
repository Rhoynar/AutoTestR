...
public class IOT_TESTING_TEST {
	static WebDriver web;
	static IOT_TESTING sc;
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/iot-testing");
    	web.manage().window().maximize();    		
		sc = new IOT_TESTING (web,mapData);
	...
	@Test 
	public void Test_clickAutotestrLink()
	{ 
		sc.clickAutotestrLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickIotTestingProductsLink()
	{ 
		sc.clickIotTestingProductsLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickIottestrLink()
	{ 
		sc.clickIottestrLink();
		/* TEST - ADD Assert Here */
	}
