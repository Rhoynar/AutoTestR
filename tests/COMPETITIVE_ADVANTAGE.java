...
public class COMPETITIVE_ADVANTAGE  {
    ...
    @FindBy(css = "#post-154 div.entry-content div.tabs-wrapper ul.tabs li:nth-of-type(5) a")
    @CacheLookup
    private WebElement continuousIntegration2;

    @FindBy(css = "#tab857 ul.list-4 li:nth-of-type(1) a")
    @CacheLookup
    private WebElement destinationjSoftwareTechnologies1;

    @FindBy(css = "#tab113 ul.list-4 li:nth-of-type(2) a")
    @CacheLookup
    private WebElement destinationjSoftwareTechnologies2;
    ...
    @FindBy(css = ".page.page-id-154.page-template-default.skt-it-consultant-pro div:nth-of-type(1) div:nth-of-type(1) div.container div:nth-of-type(1) a")
    @CacheLookup
    private WebElement home2;

    @FindBy(css = "#post-154 div.entry-content div.tabs-wrapper ul.tabs li:nth-of-type(2) a")
    @CacheLookup
    private WebElement hpQtp;

    @FindBy(css = "#post-154 div.entry-content div.tabs-wrapper ul.tabs li:nth-of-type(4) a")
    @CacheLookup
    private WebElement inHouseQaDepartment;
    ...
    @FindBy(css = "#post-154 div.entry-content div.tabs-wrapper ul.tabs li:nth-of-type(1) a")
    @CacheLookup
    private WebElement manualTest;
    ...
    @FindBy(css = "#post-154 div.entry-content div.tabs-wrapper ul.tabs li:nth-of-type(3) a")
    @CacheLookup
    private WebElement offshoreQa;

    private final String pageLoadedText = "push([ 'view', {v:'ext',j:'1:3";

    private final String pageUrl = "C:\tools\AutoTestRv0.87\html\COMPETITIVE_ADVANTAGE.html";
    ...
    public COMPETITIVE_ADVANTAGE() {
    }

    public COMPETITIVE_ADVANTAGE(WebDriver driver) {
        this();
        this.driver = driver;
    }

    public COMPETITIVE_ADVANTAGE(WebDriver driver, Map<String, String> data) {
        this(driver);
        this.data = data;
    }

    public COMPETITIVE_ADVANTAGE(WebDriver driver, Map<String, String> data, int timeout) {
        this(driver, data);
     ...
     */
    public COMPETITIVE_ADVANTAGE clickAboutUsLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickAutotestrAutomaticTestGenerationLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickBlog1Link() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickBlog2Link() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickCareers1Link() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickCareers2Link() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickCaseStudiesLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickCompanyLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickCompetitiveAdvantageLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickComprehensiveQaLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickContactUs1Link() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickContactUs2Link() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickContactrhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickContinuousIntegration1Link() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickContinuousIntegration2Link() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickDestinationjSoftwareTechnologies1Link() {
	    if(destinationjSoftwareTechnologies1.isDisplayed())
        destinationjSoftwareTechnologies1.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickDestinationjSoftwareTechnologies2Link() {
	    if(destinationjSoftwareTechnologies2.isDisplayed())
        destinationjSoftwareTechnologies2.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickDevSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickFacebookLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickFollowRhoynarsoftLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickGoogleLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickHome1Link() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickHome2Link() {
    ...
    /**
     * Click on Hp Qtp Link.
     *
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickHpQtpLink() {
	    if(hpQtp.isDisplayed())
        hpQtp.click();
        return this;
    }

    /**
     * Click on In House Qa Department Link.
     *
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickInHouseQaDepartmentLink() {
	    if(inHouseQaDepartment.isDisplayed())
        inHouseQaDepartment.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickIottestrFrameworkIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickMailrEmailAutomationLink() {
    ...
    /**
     * Click on Manual Test Link.
     *
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickManualTestLink() {
	    if(manualTest.isDisplayed())
        manualTest.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickMenuLink() {
	    if(menu.isDisplayed())
        menu.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickMigraterSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickMobileDevelopmentLink() {
    ...
    /**
     * Click on Offshore Qa Link.
     *
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickOffshoreQaLink() {
	    if(offshoreQa.isDisplayed())
        offshoreQa.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickPricingModelLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickProducts1Link() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickProducts2Link() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickQaSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickQaStaffingLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickQaTrainingLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickQtpToSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickRhoynarSoftwareConsultingDenverCoLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickSecurityTestingLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickServicesLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickSquadPresentationLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickTestimonialsLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickTrainingLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickWebAndMobileQaLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickWebDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickWhyRhoynarLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE clickWwwRhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE verifyPageLoaded() {
        return this;
    }
     ...
     * @return the  class instance.
     */
    public COMPETITIVE_ADVANTAGE verifyPageUrl() {
        return this;
    }
}
