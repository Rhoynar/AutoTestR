...
public class OPEN_POSITIONS_TEST {
	static WebDriver web;
	static OPEN_POSITIONS sc;
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/careers-2/open-positions");
    	web.manage().window().maximize();    		
		sc = new OPEN_POSITIONS (web,mapData);
	...
	@Test 
	public void Test_clickLoadMoreListingsLink()
	{ 
		sc.clickLoadMoreListingsLink();
		/* TEST - ADD Assert Here */
	}
