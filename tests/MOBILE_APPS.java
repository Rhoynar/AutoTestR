...
public class MOBILE_APPS  {
    ...
    @FindBy(css = "#post-578 div.entry-content h2 a")
    @CacheLookup
    private WebElement contactUsToLearnMoreToday;
    ...
    @FindBy(css = "#post-578 div.entry-content div:nth-of-type(3) a")
    @CacheLookup
    private WebElement getstartedred;
    ...
    @FindBy(css = ".page.page-id-578.page-template-default.skt-it-consultant-pro div:nth-of-type(1) div:nth-of-type(1) div.container div:nth-of-type(1) a")
    @CacheLookup
    ...
    @FindBy(css = ".page.page-id-578.page-template-default.skt-it-consultant-pro div:nth-of-type(1) header.header div.container div.head_fix div:nth-of-type(2) div.mobile_nav a")
    @CacheLookup
    ...
    private final String pageLoadedText = "com/wp-content/plugins/slider-image/Front_images/arrows/arrows";

    private final String pageUrl = "C:\tools\AutoTestRv0.87\html\MOBILE_APPS.html";
    ...
    public MOBILE_APPS(WebDriver driver) {
        this();
        this.driver = driver;
    }

    public MOBILE_APPS(WebDriver driver, Map<String, String> data) {
        this(driver);
        this.data = data;
    }

    public MOBILE_APPS(WebDriver driver, Map<String, String> data, int timeout) {
        this(driver, data);
     ...
     */
    public MOBILE_APPS clickAboutUsLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickAutotestrAutomaticTestGenerationLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickBlog1Link() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickBlog2Link() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickCareers1Link() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickCareers2Link() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickCaseStudiesLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickCompanyLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickCompetitiveAdvantageLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickComprehensiveQaLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickContactUs1Link() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickContactUs2Link() {
    ...
    /**
     * Click on Contact Us To Learn More Today Link.
     *
     * @return the  class instance.
     */
    public MOBILE_APPS clickContactUsToLearnMoreTodayLink() {
	    if(contactUsToLearnMoreToday.isDisplayed())
        contactUsToLearnMoreToday.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickContactrhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickContinuousIntegrationLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickDevSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickFacebookLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickFollowRhoynarsoftLink() {
    ...
    /**
     * Click on Getstartedred Link.
     *
     * @return the  class instance.
     */
    public MOBILE_APPS clickGetstartedredLink() {
	    if(getstartedred.isDisplayed())
        getstartedred.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickGoogleLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickHome1Link() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickHome2Link() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickIottestrFrameworkIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickMailrEmailAutomationLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickMenuLink() {
	    if(menu.isDisplayed())
        menu.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickMigraterSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickMobileDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickPricingModelLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickProducts1Link() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickProducts2Link() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickQaSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickQaStaffingLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickQaTrainingLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickQtpToSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickRhoynarSoftwareConsultingDenverCoLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickSecurityTestingLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickServicesLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickSquadPresentationLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickTestimonialsLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickTrainingLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickWebAndMobileQaLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickWebDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickWhyRhoynarLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS clickWwwRhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS verifyPageLoaded() {
        return this;
    }
     ...
     * @return the  class instance.
     */
    public MOBILE_APPS verifyPageUrl() {
        return this;
    }
}
