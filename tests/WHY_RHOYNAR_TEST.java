...
public class WHY_RHOYNAR_TEST {
	static WebDriver web;
	static WHY_RHOYNAR sc;
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/why-rhoynar");
    	web.manage().window().maximize();    		
		sc = new WHY_RHOYNAR (web,mapData);
	...
	@Test 
	public void Test_clickMadeincoloradoLink()
	{ 
		sc.clickMadeincoloradoLink();
		/* TEST - ADD Assert Here */
	}
