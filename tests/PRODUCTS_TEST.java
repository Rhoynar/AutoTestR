...
public class PRODUCTS_TEST {
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/products");
    	web.manage().window().maximize();    		
		sc = new PRODUCTS (web,mapData);
	...
	@Test 
	public void Test_clickAutomaticSeleniumWebdriverTestGenerationLink()
	{ 
		sc.clickAutomaticSeleniumWebdriverTestGenerationLink();
		/* TEST - ADD Assert Here */
	}

	@Test 
	public void Test_clickAutomaticTestGenerationLink()
	{ 
		sc.clickAutomaticTestGenerationLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickHarshMurari1Link()
	{ 
		sc.clickHarshMurari1Link();
		/* TEST - ADD Assert Here */
	}

	@Test 
	public void Test_clickHarshMurari2Link()
	{ 
		sc.clickHarshMurari2Link();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickMailrEmailAutomation1Link()
	{ 
		sc.clickMailrEmailAutomation1Link();
		/* TEST - ADD Assert Here */
	}

	@Test 
	public void Test_clickMailrEmailAutomation2Link()
	{ 
		sc.clickMailrEmailAutomation2Link();
		/* TEST - ADD Assert Here */
	}

	@Test 
	public void Test_clickMailrEmailAutomationSolutionLink()
	{ 
		sc.clickMailrEmailAutomationSolutionLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickMigraterQtpToSeleniumMigrationLink()
	{ 
		sc.clickMigraterQtpToSeleniumMigrationLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickPageObjectModelLink()
	{ 
		sc.clickPageObjectModelLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickReadMoreLink()
	{ 
		sc.clickReadMoreLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickRsciRhoynarSocInterfaceForIotLink()
	{ 
		sc.clickRsciRhoynarSocInterfaceForIotLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickUpto80ReductionsLink()
	{ 
		sc.clickUpto80ReductionsLink();
		/* TEST - ADD Assert Here */
	}
