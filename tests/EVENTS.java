...
public class EVENTS  {
    ...
    @FindBy(css = ".page.page-id-66.page-child.parent-pageid-64.page-template-default.skt-it-consultant-pro div:nth-of-type(1) div:nth-of-type(1) div.container div:nth-of-type(1) a")
    @CacheLookup
    ...
    private final String pageUrl = "C:\tools\AutoTestRv0.87\html\EVENTS.html";
    ...
    public EVENTS(WebDriver driver, Map<String, String> data) {
        this(driver);
        this.data = data;
    }

    public EVENTS(WebDriver driver, Map<String, String> data, int timeout) {
        this(driver, data);
     ...
     */
    public EVENTS clickAboutUsLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickAutotestrAutomaticTestGenerationLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickCareers1Link() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickCareers2Link() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickCaseStudiesLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickCompanyLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickCompetitiveAdvantageLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickComprehensiveQaLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickContactUs1Link() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickContactUs2Link() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickContactrhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickContinuousIntegrationLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickDevSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickFacebookLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickFollowRhoynarsoftLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickIottestrFrameworkIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickMailrEmailAutomationLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickMigraterSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickMobileDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickPricingModelLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickProducts1Link() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickProducts2Link() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickQaSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickQaStaffingLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickQaTrainingLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickQtpToSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickRhoynarSoftwareConsultingDenverCoLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickSecurityTestingLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickServicesLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickSquadPresentationLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickTestimonialsLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickTrainingLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickWebAndMobileQaLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickWebDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickWhyRhoynarLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS clickWwwRhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public EVENTS verifyPageLoaded() {
        return this;
    }
