...
public class QA_SERVICES_TEST {
	static WebDriver web;
	static QA_SERVICES sc;
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/qa-services");
    	web.manage().window().maximize();    		
		sc = new QA_SERVICES (web,mapData);
	...
	@Test 
	public void Test_clickInhouseComprehensiveTestingAndQaServices1Link()
	{ 
		sc.clickInhouseComprehensiveTestingAndQaServices1Link();
		/* TEST - ADD Assert Here */
	}

	@Test 
	public void Test_clickInhouseComprehensiveTestingAndQaServices2Link()
	{ 
		sc.clickInhouseComprehensiveTestingAndQaServices2Link();
		/* TEST - ADD Assert Here */
	}

	@Test 
	public void Test_clickInnovativeAndCosteffectiveSolutionsForAutomationLink()
	{ 
		sc.clickInnovativeAndCosteffectiveSolutionsForAutomationLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickOffPremiseComprehensiveTestingLink()
	{ 
		sc.clickOffPremiseComprehensiveTestingLink();
		/* TEST - ADD Assert Here */
	}

	@Test 
	public void Test_clickOndemandQaServicesLink()
	{ 
		sc.clickOndemandQaServicesLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickProductsLink()
	{ 
		sc.clickProductsLink();
		/* TEST - ADD Assert Here */
	}

	@Test 
	public void Test_clickProductsPageLink()
	{ 
		sc.clickProductsPageLink();
		/* TEST - ADD Assert Here */
	}
