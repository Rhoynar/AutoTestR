...
public class SOFTWARE_DEVELOPMENT_SERVICES_TEST {
	static WebDriver web;
	static SOFTWARE_DEVELOPMENT_SERVICES sc;
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/software-development-services");
    	web.manage().window().maximize();    		
		sc = new SOFTWARE_DEVELOPMENT_SERVICES (web,mapData);
