...
public class EXTENDED_QA_TEAM_TEST {
	static WebDriver web;
	static EXTENDED_QA_TEAM sc;
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/contact-us/company/extended-qa-team");
    	web.manage().window().maximize();    		
		sc = new EXTENDED_QA_TEAM (web,mapData);
