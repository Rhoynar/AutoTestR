...
public class BEHAVIOR_DRIVEN_TESTING_FOR_YOUR_ORGANIZATION_TEST {
	static WebDriver web;
	static BEHAVIOR_DRIVEN_TESTING_FOR_YOUR_ORGANIZATION sc;
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/blog/behavior-driven-testing-for-your-organization");
    	web.manage().window().maximize();    		
		sc = new BEHAVIOR_DRIVEN_TESTING_FOR_YOUR_ORGANIZATION (web,mapData);
	...
	@Test 
	public void Test_clickCucumberLink()
	{ 
		sc.clickCucumberLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickGherkinLink()
	{ 
		sc.clickGherkinLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickHereLink()
	{ 
		sc.clickHereLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickRspecLink()
	{ 
		sc.clickRspecLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickSpecflowLink()
	{ 
		sc.clickSpecflowLink();
		/* TEST - ADD Assert Here */
	}
