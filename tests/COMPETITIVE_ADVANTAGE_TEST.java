...
public class COMPETITIVE_ADVANTAGE_TEST {
	static WebDriver web;
	static COMPETITIVE_ADVANTAGE sc;
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/competitive-advantage");
    	web.manage().window().maximize();    		
		sc = new COMPETITIVE_ADVANTAGE (web,mapData);
	...
	@Test 
	public void Test_clickDestinationjSoftwareTechnologies1Link()
	{ 
		sc.clickDestinationjSoftwareTechnologies1Link();
		/* TEST - ADD Assert Here */
	}

	@Test 
	public void Test_clickDestinationjSoftwareTechnologies2Link()
	{ 
		sc.clickDestinationjSoftwareTechnologies2Link();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickHpQtpLink()
	{ 
		sc.clickHpQtpLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickInHouseQaDepartmentLink()
	{ 
		sc.clickInHouseQaDepartmentLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickManualTestLink()
	{ 
		sc.clickManualTestLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickOffshoreQaLink()
	{ 
		sc.clickOffshoreQaLink();
		/* TEST - ADD Assert Here */
	}
