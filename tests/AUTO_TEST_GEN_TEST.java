...
public class AUTO_TEST_GEN_TEST {
	static WebDriver web;
	static AUTO_TEST_GEN sc;
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/auto-test-gen");
    	web.manage().window().maximize();    		
		sc = new AUTO_TEST_GEN (web,mapData);
	...
	@Test 
	public void Test_clickContactUsLink()
	{ 
		sc.clickContactUsLink();
		/* TEST - ADD Assert Here */
	}
