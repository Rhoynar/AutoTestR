...
public class CONTACT_US  {
    ...
    @FindBy(css = "#post-13 div.entry-content div:nth-of-type(2) p:nth-of-type(1) a")
    @CacheLookup
    private WebElement contactrhoynarCom1;

    @FindBy(css = "#footer div.container aside:nth-of-type(4) p:nth-of-type(2) a:nth-of-type(1)")
    @CacheLookup
    ...
    @FindBy(css = ".page.page-id-13.page-parent.page-template-default.skt-it-consultant-pro div:nth-of-type(1) div:nth-of-type(1) div.container div:nth-of-type(1) a")
    @CacheLookup
    ...
    private final String pageUrl = "C:\tools\AutoTestRv0.87\html\CONTACT_US.html";
    ...
    @FindBy(id = "cscf_email-sender")
    @CacheLookup
    private WebElement sendMeACopy;

    @FindBy(css = "input[class='btn btn-default']")
    @CacheLookup
    ...
    public CONTACT_US(WebDriver driver, Map<String, String> data) {
        this(driver);
        this.data = data;
    }

    public CONTACT_US(WebDriver driver, Map<String, String> data, int timeout) {
        this(driver, data);
     ...
     */
    public CONTACT_US clickAboutUsLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickAutotestrAutomaticTestGenerationLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickBlog1Link() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickBlog2Link() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickCareers1Link() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickCareers2Link() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickCaseStudiesLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickCompanyLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickCompetitiveAdvantageLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickComprehensiveQaLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickContactUs1Link() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickContactUs2Link() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickContactrhoynarCom1Link() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickContactrhoynarCom2Link() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickContinuousIntegrationLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickDevSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickFacebookLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickFollowRhoynarsoftLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickGoogleLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickHome1Link() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickHome2Link() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickIottestrFrameworkIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickMailrEmailAutomationLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickMenuLink() {
	    if(menu.isDisplayed())
        menu.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickMigraterSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickMobileDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickPricingModelLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickProducts1Link() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickProducts2Link() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickQaSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickQaStaffingLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickQaTrainingLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickQtpToSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickRhoynarSoftwareConsultingDenverCoLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickSecurityTestingLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickSendMessageButton() {
        sendMessage.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickServicesLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickSquadPresentationLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickTestimonialsLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickTrainingLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickWebAndMobileQaLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickWebDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickWhyRhoynarLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US clickWwwRhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US fill() {
        setNameTextField();
        setEmailAddressEmailField();
        setMessageTextareaField();
        setSendMeACopyCheckboxField();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public CONTACT_US fillAndSubmit() {
        fill();
        return submit();
    }
     ...
     * @return the  class instance.
     */
    public CONTACT_US setEmailAddressEmailField() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US setEmailAddressEmailField(String emailAddressValue) {
     ...
     * @return the  class instance.
     */
    public CONTACT_US setMessageTextareaField() {
        return setMessageTextareaField(data.get("MESSAGE"));
    }
     ...
     * @return the  class instance.
     */
    public CONTACT_US setMessageTextareaField(String messageValue) {
     ...
     * @return the  class instance.
     */
    public CONTACT_US setNameTextField() {
     ...
     * @return the  class instance.
     */
    public CONTACT_US setNameTextField(String nameValue) {
        name.sendKeys(nameValue);
        return this;
    }

    /**
     * Set Send Me A Copy Checkbox field.
     *
     * @return the  class instance.
     */
    public CONTACT_US setSendMeACopyCheckboxField() {
        if (!sendMeACopy.isSelected()) {
            sendMeACopy.click();
        }
        return this;
    }
     ...
     * @return the  class instance.
     */
    public CONTACT_US submit() {
        clickSendMessageButton();
        return this;
    }

    /**
     * Unset Send Me A Copy Checkbox field.
     *
     * @return the  class instance.
     */
    public CONTACT_US unsetSendMeACopyCheckboxField() {
        if (sendMeACopy.isSelected()) {
            sendMeACopy.click();
        }
        return this;
     ...
     * @return the  class instance.
     */
    public CONTACT_US verifyPageLoaded() {
        return this;
    }
     ...
     * @return the  class instance.
     */
    public CONTACT_US verifyPageUrl() {
        return this;
    }
}
