...
public class PRICING_MODEL_TEST {
	static WebDriver web;
	static PRICING_MODEL sc;
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/why-rhoynar/pricing-model");
    	web.manage().window().maximize();    		
		sc = new PRICING_MODEL (web,mapData);
	...
	@Test 
	public void Test_clickLowCostSolutionsPageLink()
	{ 
		sc.clickLowCostSolutionsPageLink();
		/* TEST - ADD Assert Here */
	}
