...
public class OUR_MOTIVATION  {
    ...
    @FindBy(css = ".page.page-id-38.page-child.parent-pageid-36.page-template-default.skt-it-consultant-pro div:nth-of-type(1) div:nth-of-type(1) div.container div:nth-of-type(1) a")
    @CacheLookup
    ...
    private final String pageUrl = "C:\tools\AutoTestRv0.87\html\OUR_MOTIVATION.html";
    ...
    public OUR_MOTIVATION() {
    }

    public OUR_MOTIVATION(WebDriver driver) {
        this();
        this.driver = driver;
    }

    public OUR_MOTIVATION(WebDriver driver, Map<String, String> data) {
        this(driver);
        this.data = data;
    }

    public OUR_MOTIVATION(WebDriver driver, Map<String, String> data, int timeout) {
        this(driver, data);
     ...
     */
    public OUR_MOTIVATION clickAboutUsLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickAutotestrAutomaticTestGenerationLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickBlog1Link() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickBlog2Link() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickCareers1Link() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickCareers2Link() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickCaseStudiesLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickCompanyLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickCompetitiveAdvantageLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickComprehensiveQaLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickContactUs1Link() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickContactUs2Link() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickContactrhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickContinuousIntegrationLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickDevSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickFacebookLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickFollowRhoynarsoftLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickGoogleLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickHome1Link() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickHome2Link() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickIottestrFrameworkIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickMailrEmailAutomationLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickMenuLink() {
	    if(menu.isDisplayed())
        menu.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickMigraterSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickMobileDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickPricingModelLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickProducts1Link() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickProducts2Link() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickQaSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickQaStaffingLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickQaTrainingLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickQtpToSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickRhoynarSoftwareConsultingDenverCoLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickSecurityTestingLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickServicesLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickSquadPresentationLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickTestimonialsLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickTrainingLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickWebAndMobileQaLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickWebDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickWhyRhoynarLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION clickWwwRhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION verifyPageLoaded() {
        return this;
    }
     ...
     * @return the  class instance.
     */
    public OUR_MOTIVATION verifyPageUrl() {
        return this;
    }
}
