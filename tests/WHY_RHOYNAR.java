...
public class WHY_RHOYNAR  {
    ...
    @FindBy(css = "#post-36 div.entry-content p:nth-of-type(7) a")
    @CacheLookup
    ...
    @FindBy(css = ".page.page-id-36.page-parent.page-template-default.skt-it-consultant-pro div:nth-of-type(1) div:nth-of-type(1) div.container div:nth-of-type(1) a")
    @CacheLookup
    ...
    @FindBy(css = "a[href='http://i0.wp.com/www.rhoynar.com/wp-content/uploads/2015/12/made-in-colorado.png']")
    @CacheLookup
    private WebElement madeincolorado;
    ...
    private final String pageUrl = "C:\tools\AutoTestRv0.87\html\WHY_RHOYNAR.html";
    ...
    public WHY_RHOYNAR(WebDriver driver) {
        this();
        this.driver = driver;
    }

    public WHY_RHOYNAR(WebDriver driver, Map<String, String> data) {
        this(driver);
        this.data = data;
    }

    public WHY_RHOYNAR(WebDriver driver, Map<String, String> data, int timeout) {
        this(driver, data);
     ...
     */
    public WHY_RHOYNAR clickAboutUsLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickAutotestrAutomaticTestGenerationLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickBlog1Link() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickBlog2Link() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickCareers1Link() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickCareers2Link() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickCaseStudiesLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickCompanyLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickCompetitiveAdvantageLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickComprehensiveQaLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickContactUs1Link() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickContactUs2Link() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickContactrhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickContinuousIntegrationLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickDevSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickFacebookLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickFollowRhoynarsoftLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickGoogleLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickHereLink() {
	    if(here.isDisplayed())
        here.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickHome1Link() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickHome2Link() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickIottestrFrameworkIotTestingLink() {
    ...
    /**
     * Click on Madeincolorado Link.
     *
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickMadeincoloradoLink() {
	    if(madeincolorado.isDisplayed())
        madeincolorado.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickMailrEmailAutomationLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickMenuLink() {
	    if(menu.isDisplayed())
        menu.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickMigraterSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickMobileDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickPricingModelLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickProducts1Link() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickProducts2Link() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickQaSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickQaStaffingLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickQaTrainingLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickQtpToSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickRhoynarSoftwareConsultingDenverCoLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickSecurityTestingLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickServicesLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickSquadPresentationLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickTestimonialsLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickTrainingLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickWebAndMobileQaLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickWebDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickWhyRhoynarLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR clickWwwRhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR verifyPageLoaded() {
        return this;
    }
     ...
     * @return the  class instance.
     */
    public WHY_RHOYNAR verifyPageUrl() {
        return this;
    }
}
