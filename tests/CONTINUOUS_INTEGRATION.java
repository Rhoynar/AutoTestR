...
public class CONTINUOUS_INTEGRATION  {
    ...
    @FindBy(css = ".page.page-id-54.page-child.parent-pageid-6.page-template-default.skt-it-consultant-pro div:nth-of-type(1) div:nth-of-type(1) div.container div:nth-of-type(1) a")
    @CacheLookup
    ...
    private final String pageUrl = "C:\tools\AutoTestRv0.87\html\CONTINUOUS_INTEGRATION.html";
    ...
    @FindBy(css = "a[href='http://i2.wp.com/www.rhoynar.com/wp-content/uploads/2015/12/rhoynar-ci-4.png']")
    @CacheLookup
    private WebElement rhoynarAdvantageContinuousIntegrationFramework;
    ...
    public CONTINUOUS_INTEGRATION() {
    }

    public CONTINUOUS_INTEGRATION(WebDriver driver) {
        this();
        this.driver = driver;
    }

    public CONTINUOUS_INTEGRATION(WebDriver driver, Map<String, String> data) {
        this(driver);
        this.data = data;
    }

    public CONTINUOUS_INTEGRATION(WebDriver driver, Map<String, String> data, int timeout) {
        this(driver, data);
     ...
     */
    public CONTINUOUS_INTEGRATION clickAboutUsLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickAutotestrAutomaticTestGenerationLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickBlog1Link() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickBlog2Link() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickCareers1Link() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickCareers2Link() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickCaseStudiesLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickCompanyLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickCompetitiveAdvantageLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickComprehensiveQaLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickContactUs1Link() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickContactUs2Link() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickContactrhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickContinuousIntegrationLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickDevSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickFacebookLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickFollowRhoynarsoftLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickGoogleLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickHome1Link() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickHome2Link() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickIottestrFrameworkIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickMailrEmailAutomationLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickMenuLink() {
	    if(menu.isDisplayed())
        menu.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickMigraterSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickMobileDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickPricingModelLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickProducts1Link() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickProducts2Link() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickQaSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickQaStaffingLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickQaTrainingLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickQtpToSeleniumMigrationLink() {
    ...
    /**
     * Click on Rhoynar Advantage Continuous Integration Framework Link.
     *
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickRhoynarAdvantageContinuousIntegrationFrameworkLink() {
	    if(rhoynarAdvantageContinuousIntegrationFramework.isDisplayed())
        rhoynarAdvantageContinuousIntegrationFramework.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickRhoynarSoftwareConsultingDenverCoLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickSecurityTestingLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickServicesLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickSquadPresentationLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickTestimonialsLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickTrainingLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickWebAndMobileQaLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickWebDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickWhyRhoynarLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION clickWwwRhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION verifyPageLoaded() {
        return this;
    }
     ...
     * @return the  class instance.
     */
    public CONTINUOUS_INTEGRATION verifyPageUrl() {
        return this;
    }
}
