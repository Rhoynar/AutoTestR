...
public class COMPREHENSIVE_QA_TEST {
	static WebDriver web;
	static COMPREHENSIVE_QA sc;
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/qa-services/comprehensive-qa");
    	web.manage().window().maximize();    		
		sc = new COMPREHENSIVE_QA (web,mapData);
