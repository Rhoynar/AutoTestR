...
public class LOW_COST_SOLUTIONS_TEST {
	static WebDriver web;
	static LOW_COST_SOLUTIONS sc;
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/why-rhoynar/low-cost-solutions");
    	web.manage().window().maximize();    		
		sc = new LOW_COST_SOLUTIONS (web,mapData);
