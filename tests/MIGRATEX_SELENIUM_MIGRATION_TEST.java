...
public class MIGRATEX_SELENIUM_MIGRATION_TEST {
	static WebDriver web;
	static MIGRATEX_SELENIUM_MIGRATION sc;
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/products/migratex-selenium-migration");
    	web.manage().window().maximize();    		
		sc = new MIGRATEX_SELENIUM_MIGRATION (web,mapData);
