...
public class SOFTWARE_DEVELOPMENT_TRAINING_TEST {
	static WebDriver web;
	static SOFTWARE_DEVELOPMENT_TRAINING sc;
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/software-development-training");
    	web.manage().window().maximize();    		
		sc = new SOFTWARE_DEVELOPMENT_TRAINING (web,mapData);
	...
	@Test 
	public void Test_clickDestinationj1Link()
	{ 
		sc.clickDestinationj1Link();
		/* TEST - ADD Assert Here */
	}

	@Test 
	public void Test_clickDestinationj2Link()
	{ 
		sc.clickDestinationj2Link();
		/* TEST - ADD Assert Here */
	}
