...
public class COMPANY  {
    ...
    @FindBy(css = ".page.page-id-64.page-parent.page-child.parent-pageid-13.page-template-default.skt-it-consultant-pro div:nth-of-type(1) div:nth-of-type(1) div.container div:nth-of-type(1) a")
    @CacheLookup
    ...
    private final String pageUrl = "C:\tools\AutoTestRv0.87\html\COMPANY.html";
    ...
    public COMPANY(WebDriver driver, Map<String, String> data) {
        this(driver);
        this.data = data;
    }

    public COMPANY(WebDriver driver, Map<String, String> data, int timeout) {
        this(driver, data);
     ...
     */
    public COMPANY clickAboutUsLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickAutotestrAutomaticTestGenerationLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickCareers1Link() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickCareers2Link() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickCaseStudiesLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickCompetitiveAdvantageLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickComprehensiveQaLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickContactUs1Link() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickContactUs2Link() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickContactrhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickContinuousIntegrationLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickDevSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickFacebookLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickFollowRhoynarsoftLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickGoogleLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickIottestrFrameworkIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickMailrEmailAutomationLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickMigraterSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickMobileDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickPricingModelLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickProducts1Link() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickProducts2Link() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickQaSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickQaStaffingLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickQaTrainingLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickQtpToSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickRhoynarSoftwareConsultingDenverCoLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickSecurityTestingLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickServicesLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickSquadPresentationLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickTestimonialsLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickTrainingLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickWebAndMobileQaLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickWebDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickWhyRhoynarLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY clickWwwRhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public COMPANY verifyPageLoaded() {
        return this;
    }
