...
public class SECURITY_TESTING  {
    ...
    @FindBy(css = ".page.page-id-120.page-template-default.skt-it-consultant-pro div:nth-of-type(1) div:nth-of-type(1) div.container div:nth-of-type(1) a")
    @CacheLookup
    ...
    private final String pageUrl = "C:\tools\AutoTestRv0.87\html\SECURITY_TESTING.html";
    ...
    @FindBy(css = "a[href='http://i2.wp.com/www.rhoynar.com/wp-content/uploads/2015/12/web_security.jpg']")
    @CacheLookup
    private WebElement securityTestingOfWebsiteIsImportant;
    ...
    public SECURITY_TESTING() {
    }

    public SECURITY_TESTING(WebDriver driver) {
        this();
        this.driver = driver;
    }

    public SECURITY_TESTING(WebDriver driver, Map<String, String> data) {
        this(driver);
        this.data = data;
    }

    public SECURITY_TESTING(WebDriver driver, Map<String, String> data, int timeout) {
        this(driver, data);
     ...
     */
    public SECURITY_TESTING clickAboutUsLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickAutotestrAutomaticTestGenerationLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickBlog1Link() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickBlog2Link() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickCareers1Link() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickCareers2Link() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickCaseStudiesLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickCompanyLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickCompetitiveAdvantageLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickComprehensiveQaLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickContactUs1Link() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickContactUs2Link() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickContactrhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickContinuousIntegrationLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickDevSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickFacebookLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickFollowRhoynarsoftLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickGoogleLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickHome1Link() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickHome2Link() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickIottestrFrameworkIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickMailrEmailAutomationLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickMenuLink() {
	    if(menu.isDisplayed())
        menu.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickMigraterSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickMobileDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickPricingModelLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickProducts1Link() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickProducts2Link() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickQaSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickQaStaffingLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickQaTrainingLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickQtpToSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickRhoynarSoftwareConsultingDenverCoLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickSecurityTestingLink() {
    ...
    /**
     * Click on Security Testing Of Website Is Important Link.
     *
     * @return the  class instance.
     */
    public SECURITY_TESTING clickSecurityTestingOfWebsiteIsImportantLink() {
	    if(securityTestingOfWebsiteIsImportant.isDisplayed())
        securityTestingOfWebsiteIsImportant.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickServicesLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickSquadPresentationLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickTestimonialsLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickTrainingLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickWebAndMobileQaLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickWebDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickWhyRhoynarLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING clickWwwRhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING verifyPageLoaded() {
        return this;
    }
     ...
     * @return the  class instance.
     */
    public SECURITY_TESTING verifyPageUrl() {
        return this;
    }
}
