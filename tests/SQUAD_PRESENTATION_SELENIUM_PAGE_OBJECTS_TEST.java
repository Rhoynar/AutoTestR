...
public class SQUAD_PRESENTATION_SELENIUM_PAGE_OBJECTS_TEST {
	static WebDriver web;
	static SQUAD_PRESENTATION_SELENIUM_PAGE_OBJECTS sc;
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/squad-presentation-selenium-page-objects");
    	web.manage().window().maximize();    		
		sc = new SQUAD_PRESENTATION_SELENIUM_PAGE_OBJECTS (web,mapData);
	...
	@Test 
	public void Test_clickBrowserAutomationWithSeleniumWebdriverAndLink()
	{ 
		sc.clickBrowserAutomationWithSeleniumWebdriverAndLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickContactrhoynarCom1Link()
	{ 
		sc.clickContactrhoynarCom1Link();
		/* TEST - ADD Assert Here */
	}

	@Test 
	public void Test_clickContactrhoynarCom2Link()
	{ 
		sc.clickContactrhoynarCom2Link();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickLinkLink()
	{ 
		sc.clickLinkLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickPpaEventCenterLink()
	{ 
		sc.clickPpaEventCenterLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickRhoynarSoftwareConsultingLink()
	{ 
		sc.clickRhoynarSoftwareConsultingLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickWwwRhoynarCom1Link()
	{ 
		sc.clickWwwRhoynarCom1Link();
		/* TEST - ADD Assert Here */
	}

	@Test 
	public void Test_clickWwwRhoynarCom2Link()
	{ 
		sc.clickWwwRhoynarCom2Link();
		/* TEST - ADD Assert Here */
	}
