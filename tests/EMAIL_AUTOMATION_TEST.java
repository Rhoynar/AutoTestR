...
public class EMAIL_AUTOMATION_TEST {
	static WebDriver web;
	static EMAIL_AUTOMATION sc;
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/products/email-automation");
    	web.manage().window().maximize();    		
		sc = new EMAIL_AUTOMATION (web,mapData);
	...
	@Test 
	public void Test_clickHarshMurariLink()
	{ 
		sc.clickHarshMurariLink();
		/* TEST - ADD Assert Here */
	}
