...
public class CONTINUOUS_INTEGRATION_TEST {
	static WebDriver web;
	static CONTINUOUS_INTEGRATION sc;
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/qa-services/continuous-integration");
    	web.manage().window().maximize();    		
		sc = new CONTINUOUS_INTEGRATION (web,mapData);
	...
	@Test 
	public void Test_clickRhoynarAdvantageContinuousIntegrationFrameworkLink()
	{ 
		sc.clickRhoynarAdvantageContinuousIntegrationFrameworkLink();
		/* TEST - ADD Assert Here */
	}
