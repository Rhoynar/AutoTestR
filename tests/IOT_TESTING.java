...
public class IOT_TESTING  {
    ...
    @FindBy(css = "#post-117 div.entry-content div:nth-of-type(4) div.entry-content p a:nth-of-type(1)")
    @CacheLookup
    private WebElement autotestr;
    ...
    @FindBy(css = ".page.page-id-117.page-template-default.skt-it-consultant-pro div:nth-of-type(1) div:nth-of-type(1) div.container div:nth-of-type(1) a")
    @CacheLookup
    ...
    @FindBy(css = "#post-117 div.entry-content div:nth-of-type(1) p:nth-of-type(1) a")
    @CacheLookup
    private WebElement iotTestingProducts;

    @FindBy(css = "#post-117 div.entry-content div:nth-of-type(4) div.entry-content p a:nth-of-type(2)")
    @CacheLookup
    private WebElement iottestr;
    ...
    private final String pageUrl = "C:\tools\AutoTestRv0.87\html\IOT_TESTING.html";
    ...
    public IOT_TESTING(WebDriver driver) {
        this();
        this.driver = driver;
    }

    public IOT_TESTING(WebDriver driver, Map<String, String> data) {
        this(driver);
        this.data = data;
    }

    public IOT_TESTING(WebDriver driver, Map<String, String> data, int timeout) {
        this(driver, data);
     ...
     */
    public IOT_TESTING clickAboutUsLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickAutotestrAutomaticTestGenerationLink() {
    ...
    /**
     * Click on Autotestr Link.
     *
     * @return the  class instance.
     */
    public IOT_TESTING clickAutotestrLink() {
	    if(autotestr.isDisplayed())
        autotestr.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickBlog1Link() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickBlog2Link() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickCareers1Link() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickCareers2Link() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickCaseStudiesLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickCompanyLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickCompetitiveAdvantageLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickComprehensiveQaLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickContactUs1Link() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickContactUs2Link() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickContactrhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickContinuousIntegrationLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickDevSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickFacebookLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickFollowRhoynarsoftLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickGoogleLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickHome1Link() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickHome2Link() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickIotTestingLink() {
    ...
    /**
     * Click on Iot Testing Products Link.
     *
     * @return the  class instance.
     */
    public IOT_TESTING clickIotTestingProductsLink() {
	    if(iotTestingProducts.isDisplayed())
        iotTestingProducts.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickIottestrFrameworkIotTestingLink() {
    ...
    /**
     * Click on Iottestr Link.
     *
     * @return the  class instance.
     */
    public IOT_TESTING clickIottestrLink() {
	    if(iottestr.isDisplayed())
        iottestr.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickMailrEmailAutomationLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickMenuLink() {
	    if(menu.isDisplayed())
        menu.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickMigraterSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickMobileDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickPricingModelLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickProducts1Link() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickProducts2Link() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickQaSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickQaStaffingLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickQaTrainingLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickQtpToSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickRhoynarSoftwareConsultingDenverCoLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickSecurityTestingLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickServicesLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickSquadPresentationLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickTestimonialsLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickTrainingLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickWebAndMobileQaLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickWebDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickWhyRhoynarLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING clickWwwRhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public IOT_TESTING verifyPageLoaded() {
        return this;
    }
     ...
     * @return the  class instance.
     */
    public IOT_TESTING verifyPageUrl() {
        return this;
    }
}
