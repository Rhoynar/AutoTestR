...
public class MOBILE_APPS_TEST {
	static WebDriver web;
	static MOBILE_APPS sc;
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/mobile-apps");
    	web.manage().window().maximize();    		
		sc = new MOBILE_APPS (web,mapData);
	...
	@Test 
	public void Test_clickContactUsToLearnMoreTodayLink()
	{ 
		sc.clickContactUsToLearnMoreTodayLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickGetstartedredLink()
	{ 
		sc.clickGetstartedredLink();
		/* TEST - ADD Assert Here */
	}
