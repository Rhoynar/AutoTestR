...
public class CAREERS  {
    ...
    @FindBy(css = ".page.page-id-11.page-template-default.skt-it-consultant-pro div:nth-of-type(1) div:nth-of-type(1) div.container div:nth-of-type(1) a")
    @CacheLookup
    ...
    private final String pageUrl = "C:\tools\AutoTestRv0.87\html\CAREERS.html";
    ...
    public CAREERS(WebDriver driver, Map<String, String> data) {
        this(driver);
        this.data = data;
    }

    public CAREERS(WebDriver driver, Map<String, String> data, int timeout) {
        this(driver, data);
     ...
     */
    public CAREERS clickAboutUsLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickAutotestrAutomaticTestGenerationLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickCareers1Link() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickCareers2Link() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickCaseStudiesLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickCompanyLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickCompetitiveAdvantageLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickComprehensiveQaLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickContactUs1Link() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickContactUs2Link() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickContactrhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickContinuousIntegrationLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickDevSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickFacebookLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickFollowRhoynarsoftLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickGoogleLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickIottestrFrameworkIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickMailrEmailAutomationLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickMigraterSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickMobileDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickPricingModelLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickProducts1Link() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickProducts2Link() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickQaSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickQaStaffingLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickQaTrainingLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickQtpToSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickRhoynarSoftwareConsultingDenverCoLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickSecurityTestingLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickServicesLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickSquadPresentationLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickTestimonialsLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickTrainingLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickWebAndMobileQaLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickWebDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickWhyRhoynarLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS clickWwwRhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public CAREERS verifyPageLoaded() {
        return this;
    }
