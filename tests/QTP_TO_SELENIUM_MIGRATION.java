...
public class QTP_TO_SELENIUM_MIGRATION  {
    ...
    @FindBy(css = "a[title='Case study: QTP to Selenium migration']")
    @CacheLookup
    private WebElement caseStudyQtpToSeleniumMigration;

    @FindBy(css = "a[href='http://www.rhoynar.com/products/migratex-selenium-migration']")
    @CacheLookup
    private WebElement caseStudyQtpToSeleniumMigration;
    ...
    @FindBy(css = ".page.page-id-52.page-child.parent-pageid-6.page-template-default.skt-it-consultant-pro div:nth-of-type(1) div:nth-of-type(1) div.container div:nth-of-type(1) a")
    @CacheLookup
    ...
    private final String pageUrl = "C:\tools\AutoTestRv0.87\html\QTP_TO_SELENIUM_MIGRATION.html";
    ...
    @FindBy(css = "a[href='//www.slideshare.net/TarunLalwani']")
    @CacheLookup
    private WebElement tarunLalwani;
    ...
    public QTP_TO_SELENIUM_MIGRATION() {
    }

    public QTP_TO_SELENIUM_MIGRATION(WebDriver driver) {
        this();
        this.driver = driver;
    }

    public QTP_TO_SELENIUM_MIGRATION(WebDriver driver, Map<String, String> data) {
        this(driver);
        this.data = data;
    }

    public QTP_TO_SELENIUM_MIGRATION(WebDriver driver, Map<String, String> data, int timeout) {
        this(driver, data);
     ...
     */
    public QTP_TO_SELENIUM_MIGRATION clickAboutUsLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickAutotestrAutomaticTestGenerationLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickBlog1Link() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickBlog2Link() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickCareers1Link() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickCareers2Link() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickCaseStudiesLink() {
    ...
    /**
     * Click on Case Study Qtp To Selenium Migration Link.
     *
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickCaseStudyQtpToSeleniumMigrationLink() {
	    if(caseStudyQtpToSeleniumMigration.isDisplayed())
        caseStudyQtpToSeleniumMigration.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickCompanyLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickCompetitiveAdvantageLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickComprehensiveQaLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickContactUs1Link() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickContactUs2Link() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickContactrhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickContinuousIntegrationLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickDevSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickFacebookLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickFollowRhoynarsoftLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickGoogleLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickHome1Link() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickHome2Link() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickIottestrFrameworkIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickMailrEmailAutomationLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickMenuLink() {
	    if(menu.isDisplayed())
        menu.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickMigraterSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickMobileDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickPricingModelLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickProducts1Link() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickProducts2Link() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickQaSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickQaStaffingLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickQaTrainingLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickQtpToSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickRhoynarSoftwareConsultingDenverCoLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickSecurityTestingLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickServicesLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickSquadPresentationLink() {
    ...
    /**
     * Click on Tarun Lalwani Link.
     *
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickTarunLalwaniLink() {
	    if(tarunLalwani.isDisplayed())
        tarunLalwani.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickTestimonialsLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickTrainingLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickWebAndMobileQaLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickWebDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickWhyRhoynarLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION clickWwwRhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION verifyPageLoaded() {
        return this;
    }
     ...
     * @return the  class instance.
     */
    public QTP_TO_SELENIUM_MIGRATION verifyPageUrl() {
        return this;
    }
}
