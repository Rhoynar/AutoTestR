...
public class NEWS_RELEASES  {
    ...
    @FindBy(css = ".page.page-id-68.page-child.parent-pageid-64.page-template-default.skt-it-consultant-pro div:nth-of-type(1) div:nth-of-type(1) div.container div:nth-of-type(1) a")
    @CacheLookup
    ...
    private final String pageUrl = "C:\tools\AutoTestRv0.87\html\NEWS_RELEASES.html";
    ...
    public NEWS_RELEASES() {
    }

    public NEWS_RELEASES(WebDriver driver) {
        this();
        this.driver = driver;
    }

    public NEWS_RELEASES(WebDriver driver, Map<String, String> data) {
        this(driver);
        this.data = data;
    }

    public NEWS_RELEASES(WebDriver driver, Map<String, String> data, int timeout) {
        this(driver, data);
     ...
     */
    public NEWS_RELEASES clickAboutUsLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickAutotestrAutomaticTestGenerationLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickBlog1Link() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickBlog2Link() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickCareers1Link() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickCareers2Link() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickCaseStudiesLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickCompanyLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickCompetitiveAdvantageLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickComprehensiveQaLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickContactUs1Link() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickContactUs2Link() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickContactrhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickContinuousIntegrationLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickDevSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickFacebookLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickFollowRhoynarsoftLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickGoogleLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickHome1Link() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickHome2Link() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickIottestrFrameworkIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickMailrEmailAutomationLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickMenuLink() {
	    if(menu.isDisplayed())
        menu.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickMigraterSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickMobileDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickPricingModelLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickProducts1Link() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickProducts2Link() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickQaSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickQaStaffingLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickQaTrainingLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickQtpToSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickRhoynarSoftwareConsultingDenverCoLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickSecurityTestingLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickServicesLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickSquadPresentationLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickTestimonialsLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickTrainingLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickWebAndMobileQaLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickWebDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickWhyRhoynarLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES clickWwwRhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES verifyPageLoaded() {
        return this;
    }
     ...
     * @return the  class instance.
     */
    public NEWS_RELEASES verifyPageUrl() {
        return this;
    }
}
