...
public class QA_STAFFING  {
    ...
    @FindBy(css = ".page.page-id-295.page-template-default.skt-it-consultant-pro div:nth-of-type(1) div:nth-of-type(1) div.container div:nth-of-type(1) a")
    @CacheLookup
    ...
    private final String pageUrl = "C:\tools\AutoTestRv0.87\html\QA_STAFFING.html";

    @FindBy(css = "a[href='http://www.rhoynar.com/why-rhoynar/pricing-model']")
    @CacheLookup
    private WebElement pricingModel;

    @FindBy(css = "#post-295 div.entry-content div:nth-of-type(1) p:nth-of-type(1) a")
    @CacheLookup
    ...
    public QA_STAFFING(WebDriver driver) {
        this();
        this.driver = driver;
    }

    public QA_STAFFING(WebDriver driver, Map<String, String> data) {
        this(driver);
        this.data = data;
    }

    public QA_STAFFING(WebDriver driver, Map<String, String> data, int timeout) {
        this(driver, data);
     ...
     */
    public QA_STAFFING clickAboutUsLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickAutotestrAutomaticTestGenerationLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickBlog1Link() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickBlog2Link() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickCareers1Link() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickCareers2Link() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickCaseStudiesLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickCompanyLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickCompetitiveAdvantageLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickComprehensiveQaLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickContactUs1Link() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickContactUs2Link() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickContactrhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickContinuousIntegrationLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickDevSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickFacebookLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickFollowRhoynarsoftLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickGoogleLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickHome1Link() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickHome2Link() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickIottestrFrameworkIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickMailrEmailAutomationLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickMenuLink() {
	    if(menu.isDisplayed())
        menu.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickMigraterSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickMobileDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickPricingModelLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickProducts1Link() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickProducts2Link() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickProductsLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickQaSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickQaStaffingLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickQaTrainingLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickQtpToSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickRhoynarSoftwareConsultingDenverCoLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickSecurityTestingLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickServicesLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickSquadPresentationLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickTestimonialsLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickTrainingLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickWebAndMobileQaLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickWebDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickWhyRhoynarLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING clickWwwRhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public QA_STAFFING verifyPageLoaded() {
        return this;
    }
     ...
     * @return the  class instance.
     */
    public QA_STAFFING verifyPageUrl() {
        return this;
    }
}
