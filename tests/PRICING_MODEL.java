...
public class PRICING_MODEL  {
    ...
    @FindBy(css = ".page.page-id-40.page-child.parent-pageid-36.page-template-default.skt-it-consultant-pro div:nth-of-type(1) div:nth-of-type(1) div.container div:nth-of-type(1) a")
    @CacheLookup
    ...
    @FindBy(css = "a[href='http://www.rhoynar.com/why-rhoynar/low-cost-solutions']")
    @CacheLookup
    private WebElement lowCostSolutionsPage;
    ...
    private final String pageUrl = "C:\tools\AutoTestRv0.87\html\PRICING_MODEL.html";
    ...
    public PRICING_MODEL(WebDriver driver) {
        this();
        this.driver = driver;
    }

    public PRICING_MODEL(WebDriver driver, Map<String, String> data) {
        this(driver);
        this.data = data;
    }

    public PRICING_MODEL(WebDriver driver, Map<String, String> data, int timeout) {
        this(driver, data);
     ...
     */
    public PRICING_MODEL clickAboutUsLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickAutotestrAutomaticTestGenerationLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickBlog1Link() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickBlog2Link() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickCareers1Link() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickCareers2Link() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickCaseStudiesLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickCompanyLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickCompetitiveAdvantageLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickComprehensiveQaLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickContactUs1Link() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickContactUs2Link() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickContactrhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickContinuousIntegrationLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickDevSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickFacebookLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickFollowRhoynarsoftLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickGoogleLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickHome1Link() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickHome2Link() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickIotTestingLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickIottestrFrameworkIotTestingLink() {
    ...
    /**
     * Click on Low Cost Solutions Page Link.
     *
     * @return the  class instance.
     */
    public PRICING_MODEL clickLowCostSolutionsPageLink() {
	    if(lowCostSolutionsPage.isDisplayed())
        lowCostSolutionsPage.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickMailrEmailAutomationLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickMenuLink() {
	    if(menu.isDisplayed())
        menu.click();
        return this;
    }
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickMigraterSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickMobileDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickPricingModelLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickProducts1Link() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickProducts2Link() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickQaSolutionsLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickQaStaffingLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickQaTrainingLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickQtpToSeleniumMigrationLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickRhoynarSoftwareConsultingDenverCoLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickSecurityTestingLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickServicesLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickSquadPresentationLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickTestimonialsLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickTrainingLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickWebAndMobileQaLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickWebDevelopmentLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickWhyRhoynarLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL clickWwwRhoynarComLink() {
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL verifyPageLoaded() {
        return this;
    }
     ...
     * @return the  class instance.
     */
    public PRICING_MODEL verifyPageUrl() {
        return this;
    }
}
