...
public class QTP_TO_SELENIUM_MIGRATION_TEST {
	static WebDriver web;
	static QTP_TO_SELENIUM_MIGRATION sc;
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/qa-services/qtp-to-selenium-migration");
    	web.manage().window().maximize();    		
		sc = new QTP_TO_SELENIUM_MIGRATION (web,mapData);
	...
	@Test 
	public void Test_clickCaseStudyQtpToSeleniumMigrationLink()
	{ 
		sc.clickCaseStudyQtpToSeleniumMigrationLink();
		/* TEST - ADD Assert Here */
	}
	...
	@Test 
	public void Test_clickTarunLalwaniLink()
	{ 
		sc.clickTarunLalwaniLink();
		/* TEST - ADD Assert Here */
	}
