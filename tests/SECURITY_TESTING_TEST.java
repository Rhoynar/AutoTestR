...
public class SECURITY_TESTING_TEST {
	static WebDriver web;
	static SECURITY_TESTING sc;
	...
	public void BeforeTest()
	{
    	...
    	web.get("http://www.rhoynar.com/security-testing");
    	web.manage().window().maximize();    		
		sc = new SECURITY_TESTING (web,mapData);
	...
	@Test 
	public void Test_clickSecurityTestingOfWebsiteIsImportantLink()
	{ 
		sc.clickSecurityTestingOfWebsiteIsImportantLink();
		/* TEST - ADD Assert Here */
	}
